...
def index(request):
    ...
    return render(request, 'meal/index.html', {'categories': categories})

def pricing(request):
    food_items = [
        {"name": "Apple" , "category" : "Fruits", "price": "50"},
        {"name": "Burger", "category" :  "Fast Food", "price": "250"},
        {"name": "Salad", "category" : "Healthy", "price": "200"},
        {"name": "Pizza", "category" : "Fast Food", "price": "500"},
        {"name": "Orange", "category" :  "Fruits", "price": "60"}
    ]
    return render(request, 'meal/pricing.html', {'food_items':food_items})